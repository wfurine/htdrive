...
def multilayer_perceptron(X_train, X_test, y_train, y_test, 
    ...
    display_step = nn_parameters['display_step']
    test_step = nn_parameters['test_step']

    dim_input = nn_network_def['dim_input']
    dim_layer1 = nn_network_def['dim_layer1']
    dim_layer2 = nn_network_def['dim_layer2']
    dim_output = nn_network_def['dim_output']
